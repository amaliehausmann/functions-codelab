...
function makeExchange(euro, dollar, dkAmount){
    let myEuros = calculateExchange(dkAmount, euro);
    let myDollars = calculateExchange(dkAmount, dollar);

    showResult(myEuros, myDollars, dkAmount)
}
